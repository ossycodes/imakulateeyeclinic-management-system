...
$(".validation-wizard").steps({
  ...
  onFinished: function (event, currentIndex) {
    ...
    var dateOfBirthExceptYear = document.getElementById("wdateofbirthexceptyear").value;
    var sex = document.getElementById("wsex").value;
    var regDate = document.getElementById("wregdate").value;
    ...
    xhr.send(
      `fullname=${fullname}&parentname=${parentname}&address=${address}&occupation=${occupation}&phonenumber=${phonenumber}&alternativephonenumber=${alternativePhonenumber}&nextofkin=${nextOfKin}&dateofbirth=${dateOfBirth}&sex=${sex}&regdate=${regDate}&dateofbirthexceptyear=${dateOfBirthExceptYear}&cliniccardnumber=${cliniccardnumber}`
    );
