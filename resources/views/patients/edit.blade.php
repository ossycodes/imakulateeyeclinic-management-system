            ...
            <div class="col">
            	<form method="POST" novalidate id="form">
                   ...
                   <div class="form-group">
                        ...
                        <div class="controls">
                            <input type="text" id="wcliniccardnumber" value="{{ $patient->cliniccardnumber }}" name="text" class="form-control" required data-validation-required-message="This field is required"> 
                        </div>
                    </div>
					<div class="form-group">
						<h5>Full Name: <span class="text-danger">*</span></h5>
						<div class="controls">
                            <input type="text" id="wfullname" value="{{ $patient->fullname }}" name="text" class="form-control" required data-validation-required-message="This field is required"> 
                        </div>
                    </div>
                    <div class="form-group">
						<h5>Parent's Name: <span class="text-danger">*</span></h5>
						<div class="controls">
                            <input type="text" id="wparentname" value="{{ $patient->parentname }}" name="text" class="form-control" required data-validation-required-message="This field is required"> 
                        </div>
					</div>
					<div class="form-group">
						<h5>Address: <span class="text-danger">*</span></h5>
						<div class="controls">
                            <input type="text" id="waddress" value="{{ $patient->address }}" name="text" class="form-control" required data-validation-required-message="This field is required"> 
                        </div>
                    </div>
                    <div class="form-group">
						<h5>Occupation: <span class="text-danger">*</span></h5>
						<div class="controls">
                            <input type="text" id="woccupation" value="{{ $patient->occupation }}" name="text" class="form-control" required data-validation-required-message="This field is required"> 
                        </div>
                    </div>
                    <div class="form-group">
                            <h5>Phonenumber: <span class="text-danger">*</span></h5>
                            <div class="controls">
                                <input type="number" id="wphonenumber" value="{{ $patient->phonenumber }}" name="text" class="form-control" required data-validation-required-message="This field is required"> 
                            </div>
                    </div>
                    <div class="form-group">
                            <h5>Alternative Phonenumber: <span class="text-danger">*</span></h5>
                            <div class="controls">
                                <input type="number" id="walternatephonenumber" value="{{ $patient->alternativephonenumber }}" name="text" class="form-control" required data-validation-required-message="This field is required"> 
                            </div>
                    </div>
                    <div class="form-group">
                        <h5>Next Of Kin: <span class="text-danger">*</span></h5>
                        <div class="controls">
                            <input type="text" id="wnextofkin" value="{{ $patient->nextofkin }}" name="text" class="form-control" required data-validation-required-message="This field is required"> 
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="controls">
                            <input type="date" id="wdateofbirth" value="{{ $patient->dateofbirth }}" name="date" class="form-control" required data-validation-required-message="This field is required"> </div>
